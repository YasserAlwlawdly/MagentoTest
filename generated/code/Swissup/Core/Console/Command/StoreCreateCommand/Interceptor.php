...
class Interceptor extends \Swissup\Core\Console\Command\StoreCreateCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Store\Model\WebsiteFactory $websiteFactory, \Magento\Store\Model\GroupFactory $groupFactory, \Magento\Store\Model\StoreFactory $storeFactory, \Magento\Framework\Filter\FilterManager $filterManager, $name = null)
    {
        $this->___init();
        parent::__construct($websiteFactory, $groupFactory, $storeFactory, $filterManager, $name);
    }
